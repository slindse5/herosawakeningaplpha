...
import affTrack from '../audio/Spirited.wav';
import affTrackLow from '../audio/SpiritedLow (2).wav';
import xpGain from '../audio/xpmagic.wav';
import endAudio from '../audio/endSpirit.wav';
...
const TypeSp = () => {
  ...
  var corPercent = GlobalVariables.getcorPercent();
  ...
  let text_array = [
    "I am a doer",
    "I am taking action towards my dream",
    "My eyes remain forward",
    "Action is the foundational key to all success",
    "I stop thinking and start doing",
    "I act quickly, automatically",
    "More action I take, luckier I seem to get",
    "I love taking action",
    "Why am I in love with the process?",
    "My daily action is putting my dream within reach",
    "I live my dream today",
    "Action is everything",
    "The action I'm taking is creating incredible opportunities for me",
    "My focus is getting even stronger",
    "Massive action is the answer",
    "Massive action is the answer!",
    "Massive action is everything"
  ];
     ...
     <div className="overlay_blk_fast" id="overlay_blk_fast"></div>
        ...
        <div className="overlay" id="overlay_3">
          <div className="dialog">
            <div className="dialogcontainer">
              <img className="dialogbg"/>
              <h3 className="dialogtext">Channel the Persistence of the Spirited?</h3>
