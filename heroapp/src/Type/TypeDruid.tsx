...
import affTrack from '../audio/Druid.wav';
import xpGain from '../audio/xpmagic.wav';
import endAudio from '../audio/endDruid.wav';
import lvl from '../audio/levelup.wav';
import '../App.css';
import warn from '../audio/warn.wav';
import affTrackLow from '../audio/Druid2.wav';
...
const TypeD = () => {
  ...
  let text_array = [
    ...
    "I am full of star-light",
    "I let people see the real, imperfect, flawed, quirky, weird, magical person that I am",
    "I am allowing myself to love myself, and that connects me to true freedom",
    "I am me",
    "There is only one me",    
    "I am kneeling down before my true self with gratitude for who I am",   
    "Why is the world opening up as I express my true self?",    
    "I am good", 
    "My intentions, thoughts, and actions are good",    
    "I am good, and good things seek me out",    
    ...
    "I am my own friend",   
    "I am letting my light shine, and giving others permission",   
    "What I seek, I am finding within me",    
    "I am free to be new in this moment",    
    "Why am I freeing myself and releasing everything?",    
    "I love myself",    
    "Why am I now opening the door to my highest self?"
  ];
     ...
     <div className="overlay_blk_fast" id="overlay_blk_fast"></div>
        ...
        <div className="overlay" id="overlay_2">
          <div className="dialog">
            <div className="dialogcontainer">
              <img className="dialogbg"/>
              <h3 className="dialogtext">Confidence Channelled!<p>Accuracy: {Math.floor(corPercent * 10) / 10}%</p><p>Divine Knowledge Expressed: {xpM*4}</p><p>Bonus XP: {Math.round(bonusXP)} </p><div id='rankimg'><div className="rankspark"></div></div></h3>
        ...
        <div className="overlay" id="overlay_3">
          <div className="dialog">
            <div className="dialogcontainer">
              <img className="dialogbg"/>
              <h3 className="dialogtext">Channel the Confidence of the Druid?</h3>
