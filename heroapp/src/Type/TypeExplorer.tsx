...
const TypeE = () => {
  ...
  let text_array = [
    "Why do I stay open and aware to the wonders in the universe?",
    "Why do I find something magical around every corner?",    
    "I look at life through a child's eyes",    
    "I accept magic into my life",    
    "I accept that life is magic",    
    "All I have to do is open my eyes and experience the magic around me",    
    "I am enamored by the magic around me, heheh",    
    "I gaze in awe at the world around me and it's beauty",    
    "I appreciate the little things in life",    
    "My life is filled with magic and wonder",    
    "I keep my mind curious and open",    
    "I believe anything is possible",    
    "I stay young at heart and mind"
  ];
     ...
     <div className="overlay_blk_fast" id="overlay_blk_fast"></div>
        ...
        <div className="overlay" id="overlay_3">
          <div className="dialog">
            <div className="dialogcontainer">
              <img className="dialogbg"/>
              <h3 className="dialogtext">Channel the Wonder of the Explorer?</h3>
