...
const TypeS = () => {
  ...
  let text_array = [
    "I choose to visualize incredible, outstanding success",
    "I am staying focused on my objective",    
    "I ask myself 'Why can I do this?', and I find the answer",    
    "I ask myself empowering questions",    
    "Why is today an awesome day?",    
    "Why are things improving for me?",    
    "What's funny about this?",
    "I quickly shift from unproductive thinking to action-oriented thoughts",    
    "I let distractions go. My goals take precedence",    
    "I am freeing myself from attachment",    
    "I replace unproductive thoughts with empowering ones",    
    "Why am I starting to write an amazing chapter?",    
    "I choose to focus only on things that matter",    
    "My simple and noble life gives me deep fulfillment"
  ];
     ...
     <div className="overlay_blk_fast" id="overlay_blk_fast"></div>
        ...
        <div className="overlay" id="overlay_3">
          <div className="dialog">
            <div className="dialogcontainer">
              <img className="dialogbg"/>
              <h3 className="dialogtext">Channel the Focus of the Soulguard?</h3>
